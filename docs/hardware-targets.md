...
- Initial planner/scheduler recommendations using `python -m leantrain.cli recommend profiles/8x4090-measured.json --output reports/8x4090-recommendations.md`.
